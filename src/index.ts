...
export default class Bandcamp {
	 ...
	 * @param {Date | string} body.start_time -  the earliest UTC sale time an item could have and still be included in the results
	 * @param {Date | string} [body.end_time] - (optional) the latest UTC sale time an item could have and still be included in the results (default is the time of the call)
	 ...
	 * @param {'p' | 's'} items[].id_type - 'p' when id parameter refers to a payment, 's' for sale item
	 ...
	 * @param {Date | string} [items[].ship_date] - (optional) date of shipment; defaults to current date
	 * @param {string} [items[].carrier] - (optional) name of the shipping carrier (displayed to buyer)
	 * @param {number | string} [items[].tracking_code] - (optional) tracking code or number (displayed to buyer)
	 * @param {number} [version] - (optional) version of the API
	 * @returns {Promise<Response>}
	 *
	 * @example
	 ...
	 * @param {number} body.band_id - identifies the label you're calling on behalf of
	 * @param {number} [body.member_band_id] - (optional) identifies the band or artist to filter on
	 * @param {Date | string} [body.start_time] - (optional) earliest date in range of orders
	 * @param {Date | string} body.end_time - most recent date in range of orders (must be in past)
	 ...
	 * @param {'p' | 'o'} items[].id_type - "p" if id is for an item (or package), or "o" for an item-option
	 ...
	 * @param {'p', 'o'} items[].id_type - "p" if id refers to a merch item (package), or "o" an item-option
